...
import com.coinomi.core.coins.CypherfunkMain;
...
import com.coinomi.core.coins.LitedogeMain;
import com.coinomi.core.coins.MagiMain;
...
import com.coinomi.core.coins.PandacoinMain;
...
import com.coinomi.core.coins.SpartancoinMain;
...
import com.coinomi.core.coins.ZeitcoinMain;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(BitcoinMain.get(),      new ServerAddress("dwallets.crypto-with.in", 50006),
            ...
            new CoinAddress(DogecoinMain.get(),     new ServerAddress("dwallets.crypto-with.in", 50008),
            ...
            new CoinAddress(LitecoinMain.get(),     new ServerAddress("dwallets.crypto-with.in", 5002),
            ...
            new CoinAddress(PandacoinMain.get(),    new ServerAddress("pnd.droid.crypto-with.in", 50001)),
            new CoinAddress(LitedogeMain.get(),     new ServerAddress("dwallets.crypto-with.in", 50003)),
            new CoinAddress(DogecoindarkMain.get(), new ServerAddress("dwallets.crypto-with.in", 50009)),
            new CoinAddress(SpartancoinMain.get(),  new ServerAddress("dwallets.crypto-with.in", 50004)),
            new CoinAddress(ZeitcoinMain.get(),     new ServerAddress("dwallets.crypto-with.in", 50002)),
            new CoinAddress(MagiMain.get(),         new ServerAddress("dwallets.crypto-with.in", 50010)),
            new CoinAddress(CypherfunkMain.get(),   new ServerAddress("dwallets.crypto-with.in", 50007))
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.PANDACOIN_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.LITEDOGE_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.DOGECOINDARK_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.SPARTANCOIN_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.ZEITCOIN_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.MAGI_MAIN.getCoinType(), R.drawable.parkbyte);
        COINS_ICONS.put(CoinID.CYPHERFUNK_MAIN.getCoinType(), R.drawable.parkbyte);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.PANDACOIN_MAIN.getCoinType(), "");
        COINS_BLOCK_EXPLORERS.put(CoinID.LITEDOGE_MAIN.getCoinType(), "https://www.blockexperts.com/ldoge/%s");
        COINS_BLOCK_EXPLORERS.put(CoinID.DOGECOINDARK_MAIN.getCoinType(), "https://www.blockexperts.com/doged/tx/%s");
        COINS_BLOCK_EXPLORERS.put(CoinID.ZEITCOIN_MAIN.getCoinType(), "https://chainz.cryptoid.info/zeit/tx.dws?%s");
        COINS_BLOCK_EXPLORERS.put(CoinID.MAGI_MAIN.getCoinType(), "https://chainz.cryptoid.info/xmg/tx.dws?%s");
        COINS_BLOCK_EXPLORERS.put(CoinID.CYPHERFUNK_MAIN.getCoinType(), "");
        COINS_BLOCK_EXPLORERS.put(CoinID.SPARTANCOIN_MAIN.getCoinType(), "");
