 ...
 */
public enum CoinID {
    PANDACOIN_MAIN(PandacoinMain.get()),
    ...
    ZEITCOIN_MAIN(ZeitcoinMain.get()),
    CYPHERFUNK_MAIN(CypherfunkMain.get()),
    DOGECOINDARK_MAIN(DogecoindarkMain.get()),
    LITEDOGE_MAIN(LitedogeMain.get()),
    MAGI_MAIN(MagiMain.get()),
    SPARTANCOIN_MAIN(SpartancoinMain.get())
    ;
